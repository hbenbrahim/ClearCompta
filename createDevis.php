...
// 
// adresse de l'entreprise qui émet la Devis 
...
// #2 Créer une Devis 
// 
// numéro de Devis, date, texte avant le numéro de page 
$pdf->initfacture("Devis n° ".mt_rand(1, 99999)."-".mt_rand(1, 99999)."\nBC n°".mt_rand(1, 99999), "Kenitra le 29/05/2015", ""); 
// produit 
...
$pdf->Output('Devis.pdf', $_GET['download'] ? 'D':'I'); 
?>