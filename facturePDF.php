...
$this->SetCreator('Smart Design, be different'); 
$this->SetAuthor('Smart Design'); 
$this->AliasNbPages(); 
$this->template = array(); 
...
public function setLogo($aUrl='img/logo.jpg', $aWidth=30, $aX=10, $aY=6){ 
$this->logoUrl = $aUrl; 
$this->logoPosX = $aX; 
$this->logoPosY = $aY; 
...
// initialise les marges et la position 
...
// initialise la tyo et les couleurs 
